Scriptname zadx_SndEffectReBreathing10Faster extends ActiveMagicEffect
{attached to an enchantment which uses the IsMoving condition. when the wearer
is in motion it will make breathing sounds.}

Sound Property zadx_SndSoundReBreathing10Faster Auto
...
Event OnUpdate()
	...
	zadx_SndSoundReBreathing10Faster.Play(who)
	self.RegisterForSingleUpdate(Utility.RandomFloat(min,max))
	Return
EndEvent
