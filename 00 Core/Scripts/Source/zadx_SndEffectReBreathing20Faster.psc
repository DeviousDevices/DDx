Scriptname zadx_SndEffectReBreathing20Faster extends ActiveMagicEffect
{attached to an enchantment which uses the IsMoving condition. when the wearer
is in motion it will make breathing sounds.}

Sound Property zadx_SndSoundReBreathing20Faster Auto
...
Event OnUpdate()
	...
	zadx_SndSoundReBreathing20Faster.Play(who)
