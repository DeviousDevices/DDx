Scriptname zadx_SndEffectReBreathing30Faster extends ActiveMagicEffect
{attached to an enchantment which uses the IsMoving condition. when the wearer
is in motion it will make breathing sounds.}

Sound Property zadx_SndSoundReBreathing30Faster Auto
...
Event OnUpdate()
	...
	zadx_SndSoundReBreathing30Faster.Play(who)
